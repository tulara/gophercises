## Exercise
Build a REST API for tracking and discovering coffee shops with JWT authentication, middleware, and graceful shutdown.
...
`lsof -i :8080` shows processes running on port :8080
